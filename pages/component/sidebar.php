...
<div class="bg-sidebar vh-100 w-50 position-fixed">
    ...
    <div class=" bg-list d-flex flex-column align-items-center fw-bold gap-2 mt-4 ">
        <ul class="d-flex flex-column list-unstyled">
            ...
            <li class="h7"><a class=" nav-link text-dark" href="booking.php"><i class="fal fa-ticket me-2"></i> <span>Booking</span></a></li>
            <li class="h7"><a class=" nav-link text-dark" href="movie_list.php"><i class="fal fa-video me-2"></i> <span>Movies</span></a></li>
            <li class="h7"><a class=" nav-link text-dark" href="Feedback.php"><i class="fal fa-comment me-2"></i> <span>Feedback</span></a></li>

        </ul>
        <ul class="logout d-flex justify-content-start list-unstyled">
            <li class=" h7"><a class="nav-link text-dark" href="../index_a.php"><span>Logout</span><i class="fal fa-sign-out-alt ms-2"></i></a></li>
        </ul>
    </div>
