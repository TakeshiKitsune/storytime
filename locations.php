...
<body>
    ...
    <section data-bs-version="5.1" class="slider1 cid-trv39sm5UL" id="slider1-1q">
        ...
        <div class="carousel slide carousel-fade" id="trxa2IbloY" data-ride="carousel" data-bs-ride="carousel" data-interval="5000" data-bs-interval="5000">
            <ol class="carousel-indicators">
                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#trxa2IbloY" data-bs-target="#trxa2IbloY"></li>
                <li data-slide-to="1" data-bs-slide-to="1" class="" data-target="#trxa2IbloY" data-bs-target="#trxa2IbloY"></li>
                <li data-slide-to="2" data-bs-slide-to="2" class="" data-target="#trxa2IbloY" data-bs-target="#trxa2IbloY"></li>
                <li data-slide-to="3" data-bs-slide-to="3" class="" data-target="#trxa2IbloY" data-bs-target="#trxa2IbloY"></li>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item slider-image item active">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/image-800x533.jpg" alt=" " data-slide-to="0" data-bs-slide-to="0">
                ...
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/7f3ad000-a850-43d8-81f6-af2520b2605a-800x448.png" alt=" " data-slide-to="1" data-bs-slide-to="1">
                ...
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/85472c6c-33ba-458e-a33e-3f3f53e5d997-1000x560.jpg" alt=" " data-slide-to="2" data-bs-slide-to="2">
                ...
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/d325c42a-7902-41c7-92d6-6879d5434365-1-800x600.jpg" alt=" " data-slide-to="3" data-bs-slide-to="3">
            ...
            <a class="carousel-control carousel-control-prev" role="button" data-slide="prev" data-bs-slide="prev" href="#trxa2IbloY">
                <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                <span class="sr-only visually-hidden">Previous</span>
            </a>
            <a class="carousel-control carousel-control-next" role="button" data-slide="next" data-bs-slide="next" href="#trxa2IbloY">
        ...
        <div class="container-fluid">
            ...
            <div class="row mbr-gallery mt-4">
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal" data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/17d0d2b3-02c3-4fe3-9c0d-8b16241480ae-1-1000x560.jpg" alt="" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t">
                ...
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal" data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/image-1809x1206.jpg" alt="" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal" data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/85472c6c-33ba-458e-a33e-3f3f53e5d997-1000x560.jpg" alt="" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                    <h6 class="mbr-item-subtitle mbr-fonts-style align-center mb-2 mt-2 display-7"><strong>Colombo City
                            Centre<br>3D Hall / Air Condition / Cafetaria / Car park / Luxurious seats <br><a href="#maps" class="text-primary"><b>View Location</b></a></strong></h6>
                </div>
                <div class="col-12 col-md-6 col-lg-6 item gallery-image">
                    <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#trxa2IKA5t-modal" data-bs-target="#trxa2IKA5t-modal">
                        <img class="w-100" src="assets/images/7f3ad000-a850-43d8-81f6-af2520b2605a-1000x560.png" alt="" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t">
                        <div class="icon-wrapper">
                            <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                        </div>
                    </div>
                    <h6 class="mbr-item-subtitle mbr-fonts-style align-center mb-2 mt-2 display-7"><strong>Liberty By
                            Scope Cinemas - Kiribathgoda<br>3D Hall / Air Condition / Car park / Snack Bar<br><a href="#maps" class="text-primary"><b>View Location</b></a></strong></h6>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="carousel slide carousel-fade" id="lb-trxa2IKA5t" data-ride="carousel" data-bs-ride="carousel" data-interval="6000" data-bs-interval="6000">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="assets/images/17d0d2b3-02c3-4fe3-9c0d-8b16241480ae-1-1000x560.jpg" alt=" ">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="assets/images/image-1809x1206.jpg" alt=" ">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="assets/images/85472c6c-33ba-458e-a33e-3f3f53e5d997-1000x560.jpg" alt=" ">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="assets/images/7f3ad000-a850-43d8-81f6-af2520b2605a-1000x560.png" alt=" ">
                                    </div>
                                </div>
                                <ol class="carousel-indicators">
                                    <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t"></li>
                                    <li data-slide-to="1" data-bs-slide-to="1" class="" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t"></li>
                                    <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t"></li>
                                    <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-trxa2IKA5t" data-bs-target="#lb-trxa2IKA5t"></li>

                                </ol>
                                <a role="button" href="" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
                                </a>
                                <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#lb-trxa2IKA5t">
                                    <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                    <span class="sr-only visually-hidden">Previous</span>
                                </a>
                                <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#lb-trxa2IKA5t">
                                    <span class="mobi-mbri mobi-mbri-arrow-next" aria-hidden="true"></span>
                                    <span class="sr-only visually-hidden">Next</span>
                                </a>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <h4 class="mbr-section-subtitle mb-3 align-center mbr-fonts-style display-5">Liberty By Scope
                        Cinemas - Colpetty</h4>
                    <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=Liberty By Scope Cinemas, 37A Srimath Anagarika Dharmapala Mawatha, Colombo 00700" allowfullscreen=""></iframe></div>
                </div>
                <div class="col-12 col-lg-6">
                    <h4 class="mbr-section-subtitle mb-3 mt-5 mt-lg-0 align-center mbr-fonts-style display-5">MAJESTIC
                        CITY ULTRA CINEMAS</h4>
                    <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyDk89J4FSunMF33ruMVWJaJht_Ro0kvoXs&amp;q=Majestic City, 10 Station Rd, Colombo 00400" allowfullscreen=""></iframe></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCNveGQ9bfpKFwWzQLLftrR9hNiHwdqQG8&amp;q=Colombo City Centre Mall and Residences, 137 Sir James Pieris Mawatha, Colombo 00200" allowfullscreen=""></iframe></div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCNveGQ9bfpKFwWzQLLftrR9hNiHwdqQG8&amp;q=Liberty by Scope Cinemas - Kiribathgoda, Makola Road, Kiribathgoda" allowfullscreen=""></iframe></div>
                </div>
            </div>
        </div>
    </section>
