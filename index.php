...
<body oncontextmenu="return false">
    ...
    <section data-bs-version="5.1" class="cid-C76tvlGSd5 mbr-fullscreen mbr-parallax-background" id="design-block-C76tvlGSd5">
        ...
        <div class="container">
            <div class="media-container-row d-flex align-items-center">
                <div class="mbr-white col-12 col-lg-6 text-center text-lg-left py-5">
                    ...
                    <div class="pad">
                        <div class=" mbr-section-btn"><a class="ripple-click btn btn-md btn-secondary display-4" href="Movies.php">Buy Tickets</a>
    ...
    <section data-bs-version="5.1" class="slider1 cid-trorAjdlQF" id="slider1-n">
        ...
        <div class="carousel slide carousel-fade" id="trxa16Egef" data-ride="carousel" data-bs-ride="carousel" data-interval="5000" data-bs-interval="5000">
            <ol class="carousel-indicators">
                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#trxa16Egef" data-bs-target="#trxa16Egef"></li>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item slider-image item active">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/ef141bf5-da47-476e-9011-d3e794b598c7-1500x731.png" alt="Wekanada" data-slide-to="0" data-bs-slide-to="0">
                ...
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/3abf272c-dfe8-402f-94fe-d8be8206dfa8-1500x730.jpg" alt="Avatar" data-slide-to="1" data-bs-slide-to="1">
                ...
                <div class="carousel-item slider-image item">
                    <div class="item-wrapper">
                        <img class="d-block w-100" src="assets/images/stretched-1920-1080-1274206-1900x1069.jpg" alt="BlackAdam" data-slide-to="2" data-bs-slide-to="2">
            ...
            <a class="carousel-control carousel-control-prev" role="button" data-slide="prev" data-bs-slide="prev" href="#trxa16Egef">
                <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                <span class="sr-only visually-hidden">Previous</span>
            </a>
            <a class="carousel-control carousel-control-next" role="button" data-slide="next" data-bs-slide="next" href="#trxa16Egef">
                    ...
                    <div class="embla__container">
                        <div class="embla__slide slider-image item active" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/images/Chicken_Run_Dawn_of_the_Nugget-981881616-large.jpg" alt="ChickenRun" title="">
                                    </div>
                                </div>
                                ...
                                <div class="mbr-section-btn item-footer mt-2"><a href="chickenrun.php" class="btn item-btn btn-black display-7" target="_blank"><span class="ripple-hover  mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now</a></div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/img/3aij5sA5AhK2flrjsfrVQs93CUx.jpg" alt="black adam" title="" data-slide-to="1" data-bs-slide-to="1">
                                    </div>
                                </div>
                                <div class="item-content">
                                ...
                                <div class="mbr-section-btn item-footer mt-2"><a href="barbie.php" class="btn item-btn btn-black display-7" target="_blank"><span class="ripple-hover mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now</a></div>
                            </div>
                        </div>
                        <div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/img/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg" alt="wakanda" title="" data-slide-to="2" data-bs-slide-to="2">
                                    </div>
                                </div>
                                <div class="item-content">
                                ...
                                <div class="mbr-section-btn item-footer mt-2"><a href="oppenheimer.php" class="btn item-btn btn-black display-7" target="_blank"><span class="ripple-hover mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now&nbsp;</a></div>
                            </div>
                        </div>
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 3rem; margin-right: 3rem;">
                            <div class="slide-content">
                                <div class="item-img">
                                    <div class="item-wrapper">
                                        <img src="assets/img/family.jpg" alt="wakanda" title="" data-slide-to="2" data-bs-slide-to="2">
                                    </div>
                                </div>
                                <div class="item-content">
                                ...
                                <div class="mbr-section-btn item-footer mt-2"><a href="thefamilyplan.php" class="btn item-btn btn-black display-7" target="_blank"><span class="ripple-hover mobi-mbri mobi-mbri-right mbr-iconfont mbr-iconfont-btn"></span>Book
                                        Now&nbsp;</a></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="embla__container">
                            ...
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/d6eaac72-71cf-4de1-a578-67a23658942b-450x600.jpg" alt="Babylion" data-slide-to="0" data-bs-slide-to="0">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/4a271c7a-3900-4d8c-9cd1-8318558544be-450x600.jpg" alt="Quantumania" data-slide-to="1" data-bs-slide-to="1">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo1()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/c03aefa7-fede-46c9-b61c-516f34480cc3-450x600.jpg" alt="Shazam" data-slide-to="2" data-bs-slide-to="2">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo2()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/71b141af-998b-4a24-8645-b00b6cefc6da-450x600.jpg" alt="Shazam" data-slide-to="3" data-bs-slide-to="3">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo3()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/ed001717-74ca-44f2-a062-839e21f6373f-450x600.jpg" alt="Johnwick" data-slide-to="4" data-bs-slide-to="4">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo4()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/b0246e07-9c7e-4d27-9864-a40022953217-450x600.jpg" alt="Johnwick" data-slide-to="5" data-bs-slide-to="5">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo5()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/69e397a4-484f-48e3-b3e2-7d88eb2bbf23-450x600.jpg" alt="Johnwick" data-slide-to="6" data-bs-slide-to="6">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo6()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/3fc0f04d-f2d1-4581-9759-79160f2b4db0-450x600.jpg" alt="Johnwick" data-slide-to="7" data-bs-slide-to="7">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo7()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
                        ...
                        <div class="embla__slide slider-image item" style="margin-left: 0rem; margin-right: 0rem;">
                            <div class="card-wrap">
                                <div class="item-wrapper position-relative">
                                    <div class="image-wrap">
                                        <img src="assets/images/1589b87e-697f-4193-bcbc-ac9d70faf783-450x600.jpg" alt="Johnwick" data-slide-to="8" data-bs-slide-to="8">
                                    </div>
                                </div>
                                <div class="content-wrap">
                                    <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-5">
                                    ...
                                    <div class="social-row display-7">
                                        <div class="soc-item">
                                            ...
                                            <a href="#vid">
                                                <span onclick="openVideo8()" class=" mbr-iconfont mobi-mbri-play mobi-mbri"></span>
                                            </a>
                                        </div>
                                        <div class="soc-item">
                                            <a href="Movies.php" target="_blank">
        ...
        <div class="container">
            <div class="media-container-row">
                ...
                <div class="media-content">
                    ...
                    <div>
                        <a href="notfound.php" class="appstore android-btn"><img src="assets/images/pngwing.com-9-400x400.png" alt=""></a><a>
                        </a><a href="notfound.php" class="appstore ios-btn"><img src="assets/images/pngwing.com-11-400x138.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="_customHTML cid-JkGWHLfTE4" id="design-block-JkGWHLfTE4">
        ...
        <div style="padding:1rem; background-color:#c1c1c1;" class="hidden">
            <div class="align-center">
                <h10> <br><br><br><br><br><br><br><br><svg id="svg" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="150" viewBox="0, 0, 400,383.33333333333337">
                        <g id="svgg">
